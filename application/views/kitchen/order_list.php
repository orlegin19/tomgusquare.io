                ...
                if(typeof data != undefined){
                    if(Object.keys(data).length > 0){
                        ...
                        Object.keys(data).map(k=>{
                            ...
                            card.find('.card-status').html('<div class="badge badge-warning"><h4 style="color:white;">Prapering</h4></div>')
...
window.load_f = function(){
    $("#order-field .card-data").each(function(){
        $(this).click(function(){
            AjaxUniModal(75,'<?php echo base_url().'/sales/edit_order1/' ?>'+$(this).attr('data-id')+'/'+$(this).attr('data-queue')+'/1','order: '+$(this).attr('data-ref'))
        })
    })
}
